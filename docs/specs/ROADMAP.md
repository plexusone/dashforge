...
|---|---|---|---|---|
| RMI-UIFORGE-001 | Rename module uiforge → uiforge | uiforge | refactor | yes |
| RMI-UIFORGE-002 | Define UISpec core Go types (PageSpec, ComponentInstance, LayoutSpec) | uiforge | capability | yes |
| RMI-UIFORGE-003 | Implement component registry with manifest validation | uiforge | capability | yes |
| RMI-UIFORGE-004 | Define layout primitives (responsive-grid, stack, split-pane, tabs) | uiforge | capability | yes |
| RMI-UIFORGE-005 | Define experience profiles (dashboard, application, agent, portal) | uiforge | capability | yes |
| RMI-UIFORGE-006 | Generate JSON Schemas from UISpec Go types | uiforge | capability | yes |
| RMI-UIFORGE-007 | Dashboard bridge: convert DashboardIR to UISpec PageSpec | uiforge | capability | yes |
...
| ID | Title | Repo | Type | Required |
|---|---|---|---|---|
| RMI-UIFORGE-008 | Register core components (card, text, tabs, button, modal) | uiforge | capability | yes |
...
| ID | Title | Repo | Type | Required |
|---|---|---|---|---|
| RMI-UIFORGE-014 | Implement assistant.thread component adapter | uiforge | capability | yes |
| RMI-UIFORGE-015 | Implement assistant.composer and assistant.thread-list adapters | uiforge | capability | yes |
| RMI-UIFORGE-016 | Implement assistant.tool-call and assistant.run-status adapters | uiforge | capability | no |
| RMI-UIFORGE-017 | ExternalStoreRuntime adapter for AgentOS backend | uiforge | capability | yes |
| RMI-UIFORGE-018 | Define agent experience profile | uiforge | capability | yes |
| RMI-UIFORGE-019 | Sample agent workspace PageSpec with functional streaming | uiforge | quality | yes |
...
| RMI-AGENTOS-006 | Next.js page routing integration with UIForge renderer | agentos-web | capability | yes |
| RMI-AGENTOS-007 | Migrate chat components from hand-coded to UIForge composition | agentos-web | refactor | yes |
| RMI-AGENTOS-008 | AgentOS API data binding adapters | agentos | capability | yes |

### Dependencies

- RMI-AGENTOS-001 → RMI-UIFORGE-010 (needs UIForge renderer)
...
| ID | Title | Repo | Type | Required |
|---|---|---|---|---|
| RMI-UIFORGE-020 | Expression evaluator (${...} syntax) in Go and TypeScript | uiforge | capability | yes |
| RMI-UIFORGE-021 | Declarative interaction engine (event → condition → action graph) | uiforge | capability | yes |
| RMI-UIFORGE-022 | Page-level shared state management | uiforge | capability | yes |
| RMI-UIFORGE-023 | Data source connectors via UISpec bindings | uiforge | capability | yes |
| RMI-UIFORGE-024 | Dashboard drill-down interaction (chart click → table filter) | uiforge | quality | yes |
...
| ID | Title | Repo | Type | Required |
|---|---|---|---|---|
| RMI-UIFORGE-025 | Upgrade builder to load/save UISpec PageSpecs | uiforge | capability | yes |
| RMI-UIFORGE-026 | Component palette from registry | uiforge | capability | yes |
| RMI-UIFORGE-027 | Property editor from ComponentSpec manifests | uiforge | capability | yes |
| RMI-UIFORGE-028 | AI PageSpec generation with validation feedback loop | uiforge | capability | no |
| RMI-UIFORGE-029 | PageSpec diffing for code review | uiforge | quality | no |
...
|---|---|---|---|
| 1 — Foundation | 7 | 7 | uiforge |
| 2 — Components & Dashboard | 6 | 5 | uiforge |
| 3 — Assistant UI | 6 | 5 | uiforge |
| 4 — AgentOS Consumption | 8 | 6 | agentos-web (6), agentos (2) |
| 5 — Interactions & Data | 5 | 5 | uiforge |
| 6 — Builder & AI | 5 | 3 | uiforge |
| **Total** | **37** | **31** | |
