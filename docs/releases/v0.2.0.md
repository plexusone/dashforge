...
- **Multi-app Deployment** - Run UIForge as part of a larger SystemForge multi-app platform
...
UIForge can now run in both standalone and multi-app modes:
...
- [GitHub Release](https://github.com/plexusone/uiforge/releases/tag/v0.2.0)
- [Compare with v0.1.0](https://github.com/plexusone/uiforge/compare/v0.1.0...v0.2.0)
