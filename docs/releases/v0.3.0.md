...
2. Update UIForge dependency:
   ```bash
   go get github.com/plexusone/uiforge@v0.3.0
   go mod tidy
   ```

**Note:** If you only import UIForge packages (not the multiapp package), no source code changes are needed - just update the dependency and run `go mod tidy`.
...
- [GitHub Release](https://github.com/plexusone/uiforge/releases/tag/v0.3.0)
- [Compare with v0.2.0](https://github.com/plexusone/uiforge/compare/v0.2.0...v0.3.0)
