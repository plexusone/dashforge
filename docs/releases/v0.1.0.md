...
Initial release of UIForge - a JSON-first dashboard framework with AI-powered visual builder.
...
```bash
go install github.com/plexusone/uiforge/cmd/uiforge@v0.1.0
```
...
database:
  driver: postgres
  url: postgres://user:pass@localhost/uiforge
...
- [GitHub Release](https://github.com/plexusone/uiforge/releases/tag/v0.1.0)
- [Documentation](https://plexusone.github.io/uiforge/)
