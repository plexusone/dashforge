...
func (*Organization) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case organization.FieldSlug, organization.FieldName, organization.FieldLogoURL, organization.FieldDomain, organization.FieldPlan:
...
// QueryDatasources queries the "datasources" edge of the Organization entity.
func (_m *Organization) QueryDatasources() *DataSourceQuery {
	return NewOrganizationClient(_m.config).QueryDatasources(_m)
}

// QueryQueries queries the "queries" edge of the Organization entity.
func (_m *Organization) QueryQueries() *SavedQueryQuery {
	return NewOrganizationClient(_m.config).QueryQueries(_m)
}
