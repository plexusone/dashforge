...
type OrganizationQuery struct {
	...
	withDatasources          *DataSourceQuery
...
func (_q *OrganizationQuery) QueryDashboards() *DashboardQuery {
...
// QueryDatasources chains the current query on the "datasources" edge.
func (_q *OrganizationQuery) QueryDatasources() *DataSourceQuery {
	query := (&DataSourceClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (_q *OrganizationQuery) QueryQueries() *SavedQueryQuery {
...
func (_q *OrganizationQuery) QueryAlerts() *AlertQuery {
...
func (_q *OrganizationQuery) Clone() *OrganizationQuery {
	...
	return &OrganizationQuery{
		...
		withDatasources:          _q.withDatasources.Clone(),
...
func (_q *OrganizationQuery) WithDashboards(opts ...func(*DashboardQuery)) *OrganizationQuery {
	query := (&DashboardClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
// WithDatasources tells the query-builder to eager-load the nodes that are connected to
// the "datasources" edge. The optional arguments are used to configure the query builder of the edge.
func (_q *OrganizationQuery) WithDatasources(opts ...func(*DataSourceQuery)) *OrganizationQuery {
	query := (&DataSourceClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	_q.withDatasources = query
	return _q
}
...
func (_q *OrganizationQuery) WithQueries(opts ...func(*SavedQueryQuery)) *OrganizationQuery {
	query := (&SavedQueryClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *OrganizationQuery) WithAlerts(opts ...func(*AlertQuery)) *OrganizationQuery {
	query := (&AlertClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
//		GroupBy(organization.FieldSlug).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
func (_q *OrganizationQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Organization, error) {
	...
	if query := _q.withDashboards; query != nil {
		if err := _q.loadDashboards(ctx, query, nodes,
			func(n *Organization) { n.Edges.Dashboards = []*Dashboard{} },
			func(n *Organization, e *Dashboard) { n.Edges.Dashboards = append(n.Edges.Dashboards, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withDatasources; query != nil {
		if err := _q.loadDatasources(ctx, query, nodes,
			func(n *Organization) { n.Edges.Datasources = []*DataSource{} },
			func(n *Organization, e *DataSource) { n.Edges.Datasources = append(n.Edges.Datasources, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withQueries; query != nil {
		if err := _q.loadQueries(ctx, query, nodes,
			func(n *Organization) { n.Edges.Queries = []*SavedQuery{} },
			func(n *Organization, e *SavedQuery) { n.Edges.Queries = append(n.Edges.Queries, e) }); err != nil {
			return nil, err
		}
	}
	...
	if query := _q.withAlerts; query != nil {
		if err := _q.loadAlerts(ctx, query, nodes,
			func(n *Organization) { n.Edges.Alerts = []*Alert{} },
			func(n *Organization, e *Alert) { n.Edges.Alerts = append(n.Edges.Alerts, e) }); err != nil {
			return nil, err
		}
	}
...
func (_q *OrganizationQuery) loadDashboards(ctx context.Context, query *DashboardQuery, nodes []*Organization, init func(*Organization), assign func(*Organization, *Dashboard)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uuid.UUID]*Organization)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	query.Where(predicate.Dashboard(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(organization.DashboardsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
	...
	for _, n := range neighbors {
		fk := n.organization_dashboards
		if fk == nil {
			return fmt.Errorf(`foreign-key "organization_dashboards" is nil for node %v`, n.ID)
		}
		node, ok := nodeids[*fk]
		if !ok {
			return fmt.Errorf(`unexpected referenced foreign-key "organization_dashboards" returned %v for node %v`, *fk, n.ID)
		}
		assign(node, n)
	}
	return nil
}
func (_q *OrganizationQuery) loadDatasources(ctx context.Context, query *DataSourceQuery, nodes []*Organization, init func(*Organization), assign func(*Organization, *DataSource)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uuid.UUID]*Organization)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	query.withFKs = true
	query.Where(predicate.DataSource(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(organization.DatasourcesColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
	...
	for _, n := range neighbors {
		fk := n.organization_datasources
		if fk == nil {
			return fmt.Errorf(`foreign-key "organization_datasources" is nil for node %v`, n.ID)
		}
		node, ok := nodeids[*fk]
		if !ok {
			return fmt.Errorf(`unexpected referenced foreign-key "organization_datasources" returned %v for node %v`, *fk, n.ID)
		}
		assign(node, n)
	}
	return nil
}
func (_q *OrganizationQuery) loadQueries(ctx context.Context, query *SavedQueryQuery, nodes []*Organization, init func(*Organization), assign func(*Organization, *SavedQuery)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uuid.UUID]*Organization)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	query.Where(predicate.SavedQuery(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(organization.QueriesColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
	...
	for _, n := range neighbors {
		fk := n.organization_queries
		if fk == nil {
			return fmt.Errorf(`foreign-key "organization_queries" is nil for node %v`, n.ID)
		}
		node, ok := nodeids[*fk]
		if !ok {
			return fmt.Errorf(`unexpected referenced foreign-key "organization_queries" returned %v for node %v`, *fk, n.ID)
		}
		assign(node, n)
	}
	return nil
...
func (_q *OrganizationQuery) loadAlerts(ctx context.Context, query *AlertQuery, nodes []*Organization, init func(*Organization), assign func(*Organization, *Alert)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uuid.UUID]*Organization)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	query.Where(predicate.Alert(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(organization.AlertsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
	...
	for _, n := range neighbors {
		fk := n.organization_alerts
		if fk == nil {
			return fmt.Errorf(`foreign-key "organization_alerts" is nil for node %v`, n.ID)
		}
		node, ok := nodeids[*fk]
		if !ok {
			return fmt.Errorf(`unexpected referenced foreign-key "organization_alerts" returned %v for node %v`, *fk, n.ID)
		}
		assign(node, n)
	}
	return nil
