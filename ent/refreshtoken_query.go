...
func (_q *RefreshTokenQuery) QueryPrincipal() *PrincipalQuery {
...
func (_q *RefreshTokenQuery) WithPrincipal(opts ...func(*PrincipalQuery)) *RefreshTokenQuery {
	query := (&PrincipalClient{config: _q.config}).Query()
...
//		GroupBy(refreshtoken.FieldPrincipalID).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.RefreshToken.Query().
//		Select(refreshtoken.FieldPrincipalID).
//		Scan(ctx, &v)
...
func (_q *RefreshTokenQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*RefreshToken, error) {
	...
	if query := _q.withPrincipal; query != nil {
		if err := _q.loadPrincipal(ctx, query, nodes, nil,
			func(n *RefreshToken, e *Principal) { n.Edges.Principal = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *RefreshTokenQuery) loadPrincipal(ctx context.Context, query *PrincipalQuery, nodes []*RefreshToken, init func(*RefreshToken), assign func(*RefreshToken, *Principal)) error {
...
func (_q *RefreshTokenQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withPrincipal != nil {
			_spec.Node.AddColumnOnce(refreshtoken.FieldPrincipalID)
		}
	}
