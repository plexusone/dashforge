...
func (_q *PrincipalQuery) QueryOauthAccounts() *OAuthAccountQuery {
...
func (_q *PrincipalQuery) QueryRefreshTokens() *RefreshTokenQuery {
...
func (_q *PrincipalQuery) QueryDashboards() *DashboardQuery {
...
func (_q *PrincipalQuery) QueryQueries() *SavedQueryQuery {
...
func (_q *PrincipalQuery) WithOauthAccounts(opts ...func(*OAuthAccountQuery)) *PrincipalQuery {
	query := (&OAuthAccountClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *PrincipalQuery) WithRefreshTokens(opts ...func(*RefreshTokenQuery)) *PrincipalQuery {
	query := (&RefreshTokenClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *PrincipalQuery) WithDashboards(opts ...func(*DashboardQuery)) *PrincipalQuery {
	query := (&DashboardClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *PrincipalQuery) WithQueries(opts ...func(*SavedQueryQuery)) *PrincipalQuery {
	query := (&SavedQueryClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *PrincipalQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Principal, error) {
	...
	if query := _q.withOauthAccounts; query != nil {
		if err := _q.loadOauthAccounts(ctx, query, nodes,
			func(n *Principal) { n.Edges.OauthAccounts = []*OAuthAccount{} },
			func(n *Principal, e *OAuthAccount) { n.Edges.OauthAccounts = append(n.Edges.OauthAccounts, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withRefreshTokens; query != nil {
		if err := _q.loadRefreshTokens(ctx, query, nodes,
			func(n *Principal) { n.Edges.RefreshTokens = []*RefreshToken{} },
			func(n *Principal, e *RefreshToken) { n.Edges.RefreshTokens = append(n.Edges.RefreshTokens, e) }); err != nil {
			return nil, err
		}
	}
	...
	if query := _q.withDashboards; query != nil {
		if err := _q.loadDashboards(ctx, query, nodes,
			func(n *Principal) { n.Edges.Dashboards = []*Dashboard{} },
			func(n *Principal, e *Dashboard) { n.Edges.Dashboards = append(n.Edges.Dashboards, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withQueries; query != nil {
		if err := _q.loadQueries(ctx, query, nodes,
			func(n *Principal) { n.Edges.Queries = []*SavedQuery{} },
			func(n *Principal, e *SavedQuery) { n.Edges.Queries = append(n.Edges.Queries, e) }); err != nil {
			return nil, err
		}
	}
...
func (_q *PrincipalQuery) loadOauthAccounts(ctx context.Context, query *OAuthAccountQuery, nodes []*Principal, init func(*Principal), assign func(*Principal, *OAuthAccount)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uuid.UUID]*Principal)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(oauthaccount.FieldPrincipalID)
	}
	query.Where(predicate.OAuthAccount(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(principal.OauthAccountsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *PrincipalQuery) loadRefreshTokens(ctx context.Context, query *RefreshTokenQuery, nodes []*Principal, init func(*Principal), assign func(*Principal, *RefreshToken)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uuid.UUID]*Principal)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(refreshtoken.FieldPrincipalID)
	}
	query.Where(predicate.RefreshToken(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(principal.RefreshTokensColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *PrincipalQuery) loadDashboards(ctx context.Context, query *DashboardQuery, nodes []*Principal, init func(*Principal), assign func(*Principal, *Dashboard)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uuid.UUID]*Principal)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	query.Where(predicate.Dashboard(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(principal.DashboardsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
	...
	for _, n := range neighbors {
		fk := n.principal_dashboards
		if fk == nil {
			return fmt.Errorf(`foreign-key "principal_dashboards" is nil for node %v`, n.ID)
		}
		node, ok := nodeids[*fk]
		if !ok {
			return fmt.Errorf(`unexpected referenced foreign-key "principal_dashboards" returned %v for node %v`, *fk, n.ID)
		}
		assign(node, n)
	}
	return nil
}
func (_q *PrincipalQuery) loadQueries(ctx context.Context, query *SavedQueryQuery, nodes []*Principal, init func(*Principal), assign func(*Principal, *SavedQuery)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uuid.UUID]*Principal)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	query.Where(predicate.SavedQuery(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(principal.QueriesColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
	...
	for _, n := range neighbors {
		fk := n.principal_queries
		if fk == nil {
			return fmt.Errorf(`foreign-key "principal_queries" is nil for node %v`, n.ID)
		}
		node, ok := nodeids[*fk]
		if !ok {
			return fmt.Errorf(`unexpected referenced foreign-key "principal_queries" returned %v for node %v`, *fk, n.ID)
		}
		assign(node, n)
	}
	return nil
